...
from weather_data.models import Location
...
class Subscription(TimeStampedModel):
    ...
    subscription_type = models.CharField(choices=SubscriptionTypes, default="FORECAST", null=False, blank=False, max_length=50)
